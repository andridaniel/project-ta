    ...
    <div class="card m-2">
        <div>
            ...
            <div class="card m-2">
                ...
                @foreach ($siswas->hasPilihanTempatTraining as $tempatTraining)
                    <div class="m-2 p-3">
                        <form
                ...
                @foreach ($surats as $surat)
                    <div class=" p-3 m-2">
                        ...
                        <form id="deleteForm{{ $surat->id }}"
                            action="{{ route('surat_pengantar_siswa.deleteSuratPengantar', $surat->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="button" class="btn btn-danger m-2 deleteSuratPengantar"
