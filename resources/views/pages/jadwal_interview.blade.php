                    ...
                    <div class="card m-2">
                        <div class="form-group m-2">
                            <ul>
                                ...
                                <li class="text-bold">Alamat: {{ $pilihan->tempatTraining->alamat_tempat_training }}</li>
                    ...
                    <div class=" card m-3">
                        <div class="m-3">
                            <input type="text" name="keterangan" id="keterangan"
                                value="{{ $hasilInterview->keterangan }}" class=" card bg-success btn text-white" readonly>
                        </div>
                        ...
                        <form id="deleteForm{{ $hasilInterview->id }}"
                            ...
                            <button type="submit" class="btn btn-danger mx-3 mb-3 deleteSuratKerapian"
                                data-surat-id="{{ $hasilInterview->id }}">Hapus</button>
                        </form>
                    </div>
                @endforeach
            </div>
