                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <select id="guru_pembimbing_id" name="guru_pembimbing_id" class="form-control">
                                    ...
                                    <option value="{{ $update_siswa->guru_pembimbing_id }}" selected>
                                        Pembimbing Sekarang - {{ $update_siswa->hasGuruPembimbing->user->name }}</option>
                                    @foreach ($guru_pembimbing as $guru)
                                        @if ($update_siswa->guru_pembimbing_id != $guru->id)
